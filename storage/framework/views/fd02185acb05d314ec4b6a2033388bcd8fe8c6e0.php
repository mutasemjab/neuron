<?php $__env->startSection('title', __('messages.create_role')); ?>

<?php $__env->startSection('content'); ?>

<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div><h1 class="page-title"><?php echo e(__('messages.create_role')); ?></h1></div>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="panel-card">
        ...
        <div class="panel-card-body">
            <?php echo $__env->make('admin.roles._permission_groups', ['checked' => old('perms', [])], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\nuron\resources\views\admin\roles\create.blade.php ENDPATH**/ ?>