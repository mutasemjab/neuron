 ...
 <div class="row" style="row-gap: 100px;">
    ...
    <div class="col-12 col-md-6">
        ...
        <div id="editor_excerpt_ar"
             ...
             dir="rtl">
            <?php echo old('excerpt_ar', $a->excerpt_ar ?? ''); ?>

        </div>

        <textarea name="excerpt_ar"
                  class="rte-source <?php $__errorArgs = ['excerpt_ar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('excerpt_ar', $a->excerpt_ar ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-12 col-md-6">
        ...
        <div id="editor_excerpt_en"
             class="rte-editor rte-editor-sm"
             dir="ltr">
            <?php echo old('excerpt_en', $a->excerpt_en ?? ''); ?>

        </div>

        <textarea name="excerpt_en"
                  class="rte-source <?php $__errorArgs = ['excerpt_en'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('excerpt_en', $a->excerpt_en ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-12 col-md-6">
        ...
        <div id="editor_body_ar"
             class="rte-editor"
             dir="rtl">
            <?php echo old('body_ar', $a->body_ar ?? ''); ?>

        </div>

        <textarea name="body_ar"
                  class="rte-source <?php $__errorArgs = ['body_ar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('body_ar', $a->body_ar ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-12 col-md-6">
        ...
        <div id="editor_body_en"
             class="rte-editor"
             dir="ltr">
            <?php echo old('body_en', $a->body_en ?? ''); ?>

        </div>

        <textarea name="body_en"
                  class="rte-source <?php $__errorArgs = ['body_en'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('body_en', $a->body_en ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4 d-flex align-items-center">
                <div class="form-check form-switch mt-3">
                    <input class="form-check-input" type="checkbox" name="show_cover_image" value="1" id="show_cover_image" <?php if(old('show_cover_image', $a->show_cover_image ?? true)): echo 'checked'; endif; ?>>
...
<script>
(function () {
    const uploadUrl = <?php echo json_encode(route('admin.articles.editor-image'), 15, 512) ?>;
