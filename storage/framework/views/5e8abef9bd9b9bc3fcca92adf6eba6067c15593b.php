...
<header id="header">
    <div class="topbar">
        <div class="wrap">
            <div class="topbar-l">
                <a href="tel:<?php echo e(sett_raw('contact.phone')); ?>" class="hotline-link"><span class="hotline-pulse"></span><svg
                    ...
                    </svg><span><?php echo e(sett('contact.hotline_note')); ?>:
                        <strong dir="ltr"><?php echo e(sett_raw('contact.phone')); ?></strong></span></a>
                <a href="mailto:<?php echo e(sett_raw('contact.email')); ?>"><svg viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2">
                        <rect x="2" y="4" width="20" height="16" rx="2" />
                        <path d="m22 7-10 5L2 7" />
                    </svg><span><?php echo e(sett_raw('contact.email')); ?></span></a>
            </div>
            <div class="topbar-r">
                <a href="<?php echo e(route('home')); ?>#locations"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        stroke-width="2">
                        <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
                        <circle cx="12" cy="10" r="3" />
                    </svg><span><?php echo e(sett_raw('contact.branches_count')); ?> <?php echo e(__('front.topbar_branches')); ?></span></a>
                <span style="opacity:.4">|</span>
                <span><?php echo e(sett('contact.working_hours')); ?></span>
                <span style="opacity:.4">|</span>
                <a href="<?php echo e(\Mcamara\LaravelLocalization\Facades\LaravelLocalization::getLocalizedURL(app()->getLocale() === 'ar' ? 'en' : 'ar')); ?>"
                    rel="alternate"><?php echo e(__('front.lang_switch')); ?></a>
            </div>
        </div>
    </div>
    ...
    <nav class="nav">
        <div class="wrap">
            ...
            <div class="nav-links">
                ...
                <a href="<?php echo e(route('home')); ?>#svc-list"><?php echo e(__('front.nav_services')); ?></a>

                <a href="<?php echo e(route('home')); ?>#insurance"><?php echo e(__('front.Approved Insurance')); ?></a>
            ...
            <div class="nav-cta">
                <a href="<?php echo e(route('booking.page')); ?>" class="btn btn-primary"><span><?php echo e(__('front.book_now')); ?></span>
                ...
                <button class="burger" id="burger"
                    aria-label="<?php echo e(__('front.nav_menu')); ?>"><span></span><span></span><span></span></button>
            </div>
        </div>
    </nav>
</header>
...
<?php /**PATH C:\xampp\htdocs\nuron\resources\views\front\includes\navbar.blade.php ENDPATH**/ ?>