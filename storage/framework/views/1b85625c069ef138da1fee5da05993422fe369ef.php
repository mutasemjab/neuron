...
<section class="services" id="services">
  ...
  <div class="wrap">
    ...
    <div class="serv-stage reveal d1">
      ...
      <button class="serv-arrow serv-arrow-prev" id="servPrev" aria-label="<?php echo e(app()->getLocale() === 'ar' ? 'السابق' : 'Previous'); ?>">
      ...
      <div class="serv-viewport">
        <div class="serv-track" id="servTrack">
          ...
          <div class="serv-slide">
            <div class="serv-card" data-service="<?php echo e($service->id); ?>">
      ...
      <button class="serv-arrow serv-arrow-next" id="servNext" aria-label="<?php echo e(app()->getLocale() === 'ar' ? 'التالي' : 'Next'); ?>">
...
<section class="insurance" id="insurance">
  <div class="wrap">
    ...
    <div class="ins-grid reveal d1">
      ...
      <div class="ins-card">
        <?php if($company->logo): ?>
          <img class="ins-logo" src="<?php echo e($company->logo_url); ?>" alt="<?php echo e($company->name); ?>" loading="lazy">
        <?php else: ?>
          <b><?php echo e($company->name); ?></b>
        <?php endif; ?>
        <?php if($company->subtitle): ?><small><?php echo e($company->subtitle); ?></small><?php endif; ?>
      </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
<section class="testi" id="testi">
  ...
  <div class="wrap testi-wrap">
    ...
    <div class="testi-stage reveal d1">
      ...
      <button class="testi-arrow testi-arrow-prev" id="testiPrev" aria-label="<?php echo e(app()->getLocale() === 'ar' ? 'السابق' : 'Previous'); ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="15 18 9 12 15 6"/></svg>
      </button>
      ...
      <button class="testi-arrow testi-arrow-next" id="testiNext" aria-label="<?php echo e(app()->getLocale() === 'ar' ? 'التالي' : 'Next'); ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="9 18 15 12 9 6"/></svg>
      </button>
    </div>
    ...
    <div class="art-grid">
      ...
      <article class="art reveal <?php if(!$loop->first): ?> d<?php echo e($loop->iteration - 1); ?> <?php endif; ?>">
        ...
        <div class="art-body">
          ...
          <p><?php echo e($article->excerpt_plain); ?></p>
...
<section class="careers" id="careers">
  <div class="wrap">
    ...
    <div class="career-grid <?php if($careerJobs->count() === 1): ?> career-grid--single <?php endif; ?>">
      ...
      <div class="job reveal <?php if(!$loop->first): ?> d<?php echo e($loop->iteration - 1); ?> <?php endif; ?> <?php if($loop->iteration > 3): ?> job--hidden <?php endif; ?>">
    ...
    <?php if($careerJobs->count() > 3): ?>
    <div class="career-more-wrap reveal d2">
      <button type="button" class="btn btn-ghost" id="careersMoreBtn"
        data-label-more="<?php echo e(app()->getLocale() === 'ar' ? 'عرض المزيد' : 'Show More'); ?>"
        data-label-less="<?php echo e(app()->getLocale() === 'ar' ? 'عرض أقل' : 'Show Less'); ?>">
        <span><?php echo e(app()->getLocale() === 'ar' ? 'عرض المزيد' : 'Show More'); ?></span>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>
      </button>
    </div>
  ...
  <div class="wrap">
    <div class="cta-inner reveal">
      ...
      <div class="cta-row">
        ...
        <a href="tel:<?php echo e(sett_raw('contact.phone')); ?>" class="btn btn-ghost btn-lg" style="color:#fff;border-color:rgba(255,255,255,.3)"><?php echo e(__('front.call_us')); ?>: <bdi dir="ltr"><?php echo e(sett_raw('contact.phone')); ?></bdi></a>
      </div>
    </div>
  </div>
</section>
