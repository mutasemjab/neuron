...
<?php $__env->startSection('meta_description', $article->meta_description ?: $article->excerpt_plain); ?>
...
<div class="wrap">
  ...
  <?php if($article->excerpt): ?><div class="ap-lead"><?php echo $article->excerpt; ?></div><?php endif; ?>
  ...
  <?php if($article->image && $article->show_cover_image): ?>
  <div class="ap-cover">
    ...
    <div class="ap-related-grid">
      ...
      <a href="<?php echo e(route('articles.show', $related)); ?>" class="ap-related-card">
        ...
        <div class="ap-related-body">
          ...
          <p><?php echo e($related->excerpt_plain); ?></p>
        </div>
      </a>
