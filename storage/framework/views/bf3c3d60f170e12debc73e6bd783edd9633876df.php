<?php $__env->startSection('title', $careerJob->title . ' — ' . sett('identity.site_name')); ?>
<?php $__env->startSection('meta_description', $careerJob->description); ?>
  ...
  <div class="wrap">
    <div class="jap-wrap">
      ...
      <div class="jap-job-card">
        <?php if($careerJob->type): ?><span class="jap-job-type"><?php echo e($careerJob->type); ?></span><?php endif; ?>
        <h1><?php echo e($careerJob->title); ?></h1>
        <p><?php echo e($careerJob->description); ?></p>
        <?php if($careerJob->location): ?>
        <span class="jap-job-loc">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
          <?php echo e($careerJob->location); ?>
      ...
      <div class="jap-form-card">
        <form class="book-ajax-form" action="<?php echo e(route('careers.apply.store', $careerJob)); ?>" method="POST" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          <div class="form-row">
          ...
          <div class="field full" style="margin-bottom:18px">
            <label><?php echo e(app()->getLocale() === 'ar' ? 'البريد الإلكتروني' : 'Email'); ?> <span class="req">*</span></label>
            <input type="email" name="email" dir="ltr" required placeholder="name@example.com">
          </div>
          <div class="field full" style="margin-bottom:18px">
            <label><?php echo e(app()->getLocale() === 'ar' ? 'الفرع' : 'Branch'); ?> <span class="req">*</span></label>
            <select name="branch_id" required>
              <option value=""><?php echo e(app()->getLocale() === 'ar' ? 'اختر الفرع' : 'Select branch'); ?></option>
          ...
          <div class="field full" style="margin-bottom:18px">
            <label><?php echo e(app()->getLocale() === 'ar' ? 'السيرة الذاتية (CV)' : 'Resume (CV)'); ?></label>
            <input type="file" name="cv" accept=".pdf,.doc,.docx">
            <span class="field-hint"><?php echo e(app()->getLocale() === 'ar' ? 'PDF أو Word — بحد أقصى 10MB (اختياري)' : 'PDF or Word — max 10MB (optional)'); ?></span>
          </div>
          <div class="field full" style="margin-bottom:18px">
            <label><?php echo e(app()->getLocale() === 'ar' ? 'رسالة تعريفية' : 'Cover Message'); ?></label>
            <textarea name="message" placeholder="<?php echo e(app()->getLocale() === 'ar' ? 'اكتب نبذة عن خبرتك...' : 'Tell us about your experience...'); ?>"></textarea>
          </div>
          <button type="submit" class="btn btn-primary btn-lg"><span><?php echo e(app()->getLocale() === 'ar' ? 'إرسال الطلب' : 'Submit Application'); ?></span>
        ...
        <div class="form-success">
          ...
          <h3><?php echo e(app()->getLocale() === 'ar' ? 'تم استلام طلبك بنجاح' : 'Your Application Has Been Received'); ?></h3>
          <p><?php echo e(app()->getLocale() === 'ar' ? 'سيراجع فريق التوظيف طلبك وسيتواصل معك في حال وجود تطابق مع المتطلبات.' : 'Our recruitment team will review your application and reach out if there is a match.'); ?></p>
        </div>
      </div>
