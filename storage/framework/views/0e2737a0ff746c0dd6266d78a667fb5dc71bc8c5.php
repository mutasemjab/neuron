    ...
    <div class="col-12 col-lg-4">
        <div class="panel-card mb-3">
            ...
            <div class="panel-card-body">
                ...
                ?>
                <span class="badge bg-<?php echo e($payColors[$consultation->payment_status] ?? 'secondary'); ?> mb-2"><?php echo e($payLabels[$consultation->payment_status] ?? $consultation->payment_status); ?></span>
                <?php if($consultation->amount): ?>
                    <p class="mb-0"><?php echo e(number_format($consultation->amount, 2)); ?> <?php echo e($consultation->currency); ?></p>
                <?php endif; ?>
            </div>
        </div>
