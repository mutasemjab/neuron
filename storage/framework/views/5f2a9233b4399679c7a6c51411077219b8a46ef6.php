            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="<?php echo e(route('admin.articles.toggle', $article)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a href="<?php echo e(route('admin.articles.edit', $article)); ?>" class="btn-outline-sm"><i class="bi bi-pencil"></i></a>
                                <form action="<?php echo e(route('admin.articles.destroy', $article)); ?>" method="POST" onsubmit="return confirm('هل أنت متأكد من الحذف؟')">
