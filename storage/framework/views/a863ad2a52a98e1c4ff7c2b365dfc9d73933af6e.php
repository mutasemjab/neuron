<?php $__env->startSection('title', sett('legal.privacy_title') . ' — ' . sett('identity.site_name')); ?>
<?php $__env->startSection('meta_description', sett('legal.privacy_title')); ?>
  ...
  <div class="wrap">
    <div class="pp-wrap">
      ...
      <div class="pp-crumbs">
        ...
        <span>/</span>
        <span><?php echo e(sett('legal.privacy_title')); ?></span>
      </div>

      <h1 class="pp-title"><?php echo e(sett('legal.privacy_title')); ?></h1>
      <p class="pp-updated"><?php echo e(app()->getLocale() === 'ar' ? 'آخر تحديث' : 'Last updated'); ?>: <?php echo e(now()->translatedFormat('d M Y')); ?></p>
      <div class="pp-content">
        <?php echo $__env->make('front._legal_content', ['content' => sett('legal.privacy_content')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      </div>
