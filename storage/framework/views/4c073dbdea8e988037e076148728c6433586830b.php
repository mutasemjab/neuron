      ...
      <div style="padding:28px;">
        <table style="width:100%;border-collapse:collapse;font-size:14px;color:#1a2e2b;">
          <tr>
            ...
            <td style="padding:10px 0;border-bottom:1px solid #eee;font-weight:bold"><?php echo e($consultation->name); ?></td>
          </tr>
          <tr>
            <td style="padding:10px 0;border-bottom:1px solid #eee;color:#6b7d7a">البريد الإلكتروني</td>
            <td style="padding:10px 0;border-bottom:1px solid #eee;font-weight:bold" dir="ltr"><?php echo e($consultation->email); ?></td>
          </tr>
          <tr>
            <td style="padding:10px 0;border-bottom:1px solid #eee;color:#6b7d7a">الهاتف / واتساب</td>
            <td style="padding:10px 0;border-bottom:1px solid #eee" dir="ltr"><?php echo e($consultation->phone_country_code); ?> <?php echo e($consultation->phone); ?></td>
          </tr>
          <tr>
            <td style="padding:10px 0;border-bottom:1px solid #eee;color:#6b7d7a">بلد الإقامة</td>
            <td style="padding:10px 0;border-bottom:1px solid #eee"><?php echo e($consultation->country_of_residence); ?></td>
          </tr>
          <tr>
            <td style="padding:10px 0;border-bottom:1px solid #eee;color:#6b7d7a">تاريخ الميلاد</td>
            <td style="padding:10px 0;border-bottom:1px solid #eee"><?php echo e($consultation->date_of_birth->format('Y-m-d')); ?></td>
          </tr>
          <tr>
            <td style="padding:10px 0;border-bottom:1px solid #eee;color:#6b7d7a">الأيام المناسبة</td>
            <td style="padding:10px 0;border-bottom:1px solid #eee"><?php echo e($consultation->preferred_days_label ?: '—'); ?></td>
          </tr>
          <tr>
            <td style="padding:10px 0;border-bottom:1px solid #eee;color:#6b7d7a">الفترة المناسبة</td>
            <td style="padding:10px 0;border-bottom:1px solid #eee"><?php echo e($consultation->preferred_periods_label ?: '—'); ?></td>
          </tr>
          <tr>
            <td style="padding:10px 0;color:#6b7d7a;vertical-align:top">وصف الحالة</td>
            <td style="padding:10px 0;white-space:pre-line"><?php echo e($consultation->condition_description); ?></td>
          </tr>
        </table>
        ...
        <div style="margin-top:20px">
          ...
          <?php $__currentLoopData = $consultation->attachment_urls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e($url); ?>" style="display:block;color:#2a807d;font-weight:bold;text-decoration:none;margin-bottom:4px">📎 ملف <?php echo e($i + 1); ?></a>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <?php endif; ?>

        <div style="margin-top:26px;text-align:center">
          <a href="<?php echo e(route('admin.consultations.show', $consultation)); ?>" style="display:inline-block;background:#2a807d;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:bold">عرض الطلب في لوحة التحكم</a>
        </div>
      </div>
...
<?php /**PATH C:\xampp\htdocs\nuron\resources\views\emails\new_consultation.blade.php ENDPATH**/ ?>