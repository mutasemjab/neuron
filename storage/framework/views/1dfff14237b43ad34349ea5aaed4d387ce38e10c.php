  ...
  <div class="wrap">
    ...
    <div class="book-step active" data-step="choice">
      <div class="book-choice-grid">
        ...
        <button type="button" class="book-choice-card reveal" data-choose="domestic">
          ...
          <h3><?php echo e(app()->getLocale() === 'ar' ? 'داخل الأردن' : 'Inside Jordan'); ?></h3>
          <p><?php echo e(app()->getLocale() === 'ar' ? 'احجز موعدك في أحد فروعنا داخل المملكة بخطوات بسيطة وسريعة.' : 'Book your appointment at one of our branches inside the Kingdom in a few quick steps.'); ?></p>
          <span class="book-choice-cta">
            <?php echo e(app()->getLocale() === 'ar' ? 'احجز الآن' : 'Book Now'); ?>
        ...
        <button type="button" class="book-choice-card reveal" data-choose="international">
          ...
          <h3><?php echo e(app()->getLocale() === 'ar' ? 'خارج الأردن' : 'Outside Jordan'); ?></h3>
          <p><?php echo e(app()->getLocale() === 'ar' ? 'احجز استشارتك عن بُعد وأرفق تقاريرك الطبية ليطّلع عليها فريقنا مسبقاً.' : 'Book your consultation remotely and attach your medical reports for our team to review in advance.'); ?></p>
          <span class="book-choice-cta">
            <?php echo e(app()->getLocale() === 'ar' ? 'احجز الآن' : 'Book Now'); ?>
    ...
    <div class="book-step" data-step="domestic">
      <button type="button" class="book-back" data-back>
        ...
        <?php echo e(app()->getLocale() === 'ar' ? 'تغيير الخيار' : 'Change Option'); ?>
      ...
      <div class="book-page-card">
        <div class="book-page-card-head">
          ...
          <h2><?php echo e(app()->getLocale() === 'ar' ? 'حجز موعد داخل الأردن' : 'Book an Appointment Inside Jordan'); ?></h2>
          <p><?php echo e(app()->getLocale() === 'ar' ? 'عبّي بياناتك وفريق المواعيد بيتواصل معك لتأكيد الحجز.' : 'Fill in your details and our appointments team will contact you to confirm the booking.'); ?></p>
        </div>
        ...
        <form class="book-ajax-form" action="<?php echo e(route('appointments.store')); ?>" method="POST">
          ...
          <div class="form-row">
            <div class="field full" style="grid-column:1/-1">
              <label><?php echo e(__('front.form_time')); ?> <span class="req">*</span></label>
    ...
    <div class="book-step" data-step="international">
      ...
      <div class="book-page-card">
        <div class="book-page-card-head">
          ...
          <h2><?php echo e(app()->getLocale() === 'ar' ? 'حجز موعد من خارج الأردن' : 'Book an Appointment From Outside Jordan'); ?></h2>
          <p><?php echo e(app()->getLocale() === 'ar' ? 'عبّي بياناتك وأرفق تقاريرك الطبية وفريقنا بيتواصل معك لتأكيد الحجز.' : 'Fill in your details, attach your medical reports, and our team will contact you to confirm the booking.'); ?></p>
        </div>
        ...
        <div class="book-price-badge">
          ...
          <div>
            <span class="bp-label"><?php echo e(app()->getLocale() === 'ar' ? 'سعر الحجز' : 'Booking Price'); ?></span>
            <span class="bp-value"><?php echo e(sett('booking_page.price')); ?></span>
            <?php if(sett('booking_page.price_note')): ?><span class="bp-note"><?php echo e(sett('booking_page.price_note')); ?></span><?php endif; ?>
          </div>
        </div>
        <?php endif; ?>

        <form class="book-ajax-form" action="<?php echo e(route('appointments.store')); ?>" method="POST" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          ...
          <div class="field full" style="margin-bottom:18px">
            <label><?php echo e(app()->getLocale() === 'ar' ? 'إرفاق الملفات المرضية' : 'Attach Medical Files'); ?></label>
            <input type="file" name="attachment" accept=".pdf,.jpg,.jpeg,.png,.doc,.docx">
            <span class="field-hint"><?php echo e(app()->getLocale() === 'ar' ? 'PDF أو صورة أو Word — بحد أقصى 10MB (اختياري)' : 'PDF, image, or Word file — max 10MB (optional)'); ?></span>
          </div>
          <div class="field full" style="margin-bottom:18px"><label><?php echo e(__('front.form_notes')); ?></label><textarea name="notes" placeholder="<?php echo e(__('front.form_notes_ph')); ?>"></textarea></div>
          <button type="submit" class="btn btn-primary btn-lg"><span><?php echo e(__('front.form_submit')); ?></span>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M13 6l6 6-6 6"/></svg>
