    ...
    <div class="book-step" data-step="international">
      ...
      <div class="book-page-card">
        ...
        <div class="book-price-badge">
          ...
          <div>
            <span class="bp-label"><?php echo e($isAr ? 'سعر الاستشارة الأونلاين' : 'Online Consultation Price'); ?></span>
        ...
        <form class="book-ajax-form" id="consultForm" action="<?php echo e(route('consultations.store')); ?>" method="POST" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
        ...
        <div class="form-success">
          ...
          <div class="consult-pay-box" id="consultPayBox">
            ...
            <p class="field-hint" style="text-align:center;margin-top:10px"><?php echo e($isAr ? 'الدفع الآن اختياري، ويمكنك أيضاً الدفع لاحقاً عند تواصل فريقنا معك.' : 'Paying now is optional — you can also pay later when our team contacts you.'); ?></p>
          </div>
...
(function () {
  ...
  const cfg = {
    ...
    i18n: {
      ...
      failed:     <?php echo json_encode($isAr ? 'تعذّر إتمام الدفع. يمكنك المحاولة مرة أخرى لاحقًا.' : 'Payment could not be completed. You can try again later.', 15, 512) ?>,
