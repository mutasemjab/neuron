<?php $__env->startSection('title', __('messages.edit_employee')); ?>

<?php $__env->startSection('content'); ?>

<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div><h1 class="page-title"><?php echo e(__('messages.edit_employee')); ?></h1></div>
...
<form action="<?php echo e(route('admin.employee.update', $admin->id)); ?>" method="POST">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-12 col-md-6">
                    <label class="form-label"><?php echo e(__('messages.password_label')); ?></label>
...
unset($__errorArgs, $__bag); ?>" placeholder="اتركه فارغاً لعدم التغيير">
        ...
        <div class="panel-card-body">
            <div class="d-flex flex-wrap gap-3">
                ...
                <label class="d-flex align-items-center gap-2" style="cursor:pointer">
                    <input type="checkbox" name="roles[]" value="<?php echo e($role->id); ?>" <?php echo e(in_array($role->id, old('roles', $adminRole)) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\nuron\resources\views\admin\employee\edit.blade.php ENDPATH**/ ?>