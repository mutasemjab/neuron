...
<div class="cc-picker" data-cc>
    <input type="hidden" name="phone_country_code" value="<?php echo e($default['dial']); ?>" data-cc-value>

    <button type="button" class="cc-btn" data-cc-btn aria-haspopup="listbox" aria-expanded="false">
        <img class="cc-flag" src="<?php echo e($flag($default['iso'])); ?>" alt="" data-cc-flag>
        <span class="cc-dial" dir="ltr" data-cc-dial><?php echo e($default['dial']); ?></span>
    ...
    <div class="cc-panel" data-cc-panel hidden>
        <input type="text" class="cc-search" data-cc-search placeholder="<?php echo e($isAr ? 'ابحث عن دولة...' : 'Search country...'); ?>" autocomplete="off">
        <ul class="cc-list" role="listbox">
            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li role="option" class="cc-item <?php if($country['iso'] === $default['iso']): ?> is-selected <?php endif; ?>"
                    data-dial="<?php echo e($country['dial']); ?>"
                    data-flag="<?php echo e($flag($country['iso'])); ?>"
                    data-search="<?php echo e(mb_strtolower($country['name_ar'] . ' ' . $country['name_en'] . ' ' . $country['dial'])); ?>">
                    <img class="cc-flag" src="<?php echo e($flag($country['iso'])); ?>" alt="" loading="lazy">
                    <span class="cc-name"><?php echo e($isAr ? $country['name_ar'] : $country['name_en']); ?></span>
                    <span class="cc-code" dir="ltr"><?php echo e($country['dial']); ?></span>
                </li>
...
<?php if (! $__env->hasRenderedOnce('0c4cdf9f-9d4b-40c7-8ede-f9fae26f68e7')): $__env->markAsRenderedOnce('0c4cdf9f-9d4b-40c7-8ede-f9fae26f68e7'); ?>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\nuron\resources\views\front\_country_code_picker.blade.php ENDPATH**/ ?>